      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            "http://localhost:4000/admin/electrician"
          );
  ...
  return (
    <div>
        ...
        <div style={{ width: "80px", marginTop: "100px", position: "fixed" }}>
          <img
            src="https://img.freepik.com/premium-vector/handyman-vector-stock-illustration-handyman-line-art_701164-586.jpg?w=740"
            alt=""
          />
        </div>
